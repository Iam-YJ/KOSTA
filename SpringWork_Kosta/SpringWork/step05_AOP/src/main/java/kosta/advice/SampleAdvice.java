...
public class SampleAdvice {
	 ...
	 * 
	 * 인수 Object는 joinPoint 대상이 실행된 후 리턴한 값을 받는 매개변수 인수의 obj 이름은 xml의 설정의
	 * returning="obj"와 동일해야한다
	 */
	 ...
	 * 
	 * 인수 Throwable 은 예외에 대한 정보를 매개변수로 전달 받는다 인수 e는 xml의 설정 throwing="e"와 동일
	 */
