...
@Service("advice")
@Aspect //xml의 기준 <aop:aspect ref="advice"/> 와 동일
public class TimerAdvice {
	
	@Pointcut("execution(* kosta.exam.*Service*.*ello(..))")
	public void pointCut() {}
	
	
	//@Around("execution(* kosta.exam.*Service*.*ello(..))") //직접 집어넣어서 1회성
	@Around("pointCut()") //메소드 이름으로 넣어야한다
