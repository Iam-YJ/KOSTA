...
function checkValid() {
	...
	if ( f.modelNum.value == "") { //ElectronicsDTO와 이름이 같아야한다
	    alert( "모델번호를 입력해 주세요." );
	    f.model_num.focus();
		return false;
    }
...
<form name="writeForm" method="post" action="writeForm" onSubmit='return checkValid()' enctype="multipart/form-data">
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border="1" >
    ...
    <tr>
		...
		<input type=text name="modelNum" size="30"></span></b></td> <!-- ElectronicsDTO에서 설정한 이름과 같아야한다. model_name에서 modelNum으로 -->
    </tr>
    <tr>
        <td width="150" height="20">
