...
<body class="fixed-nav sticky-footer" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">게시물 자세히보기</li>
			</ol>

			<!-- Example DataTables Card-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i>&nbsp자세히보기
				</div>
				<div class="card-body">
    ...
    <tr>
        <td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">게시물 번호</span></b></p>
        </td>
    ...
    <tr>
        <td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">유저 번호</span></b></p>
        </td>
        <td width="450" height="20" colspan="3">
    ...
    <tr>
        <td width="100" height="20">
            <p align="right"><b><span style="font-size:9pt;">강퇴 목록</span></b></p>
        </td>
    ...
    <tr>
		<td width="100" height="100" valign="top">
            <p align="right"><b><span style="font-size:9pt;">사유</span></b></p>
        </td>
