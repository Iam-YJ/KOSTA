				...
				<div class="col-md-6">
					<div class="box_general padding_bottom">
						<div class="agree">
							...
							<hr>
							<form
								action="${pageContext.request.contextPath}/dispatcher?key=user&methodName=interestInsert2"
								method="post">
								<!-- .agree -->
								<ul>
									<li><label for="a2"><span>한식&nbsp&nbsp</span></label><input
										type="checkbox" value="한식" name="interests" /></li>

									<li><label for="a3"><span>중식&nbsp&nbsp</span><input
											type="checkbox" value="중식" name="interests" /></label></li>

									<li><label for="a4"><span>일식&nbsp&nbsp</span><input
											type="checkbox" value="일식" name="interests" /></label></li>

									<li><label for="a4"><span>양식&nbsp&nbsp</span><input
											type="checkbox" value="양식" name="interests" /></label></li>

									<li><label for="a4"><span>카페&nbsp&nbsp</span><input
											type="checkbox" value="카페" name="interests" /></label></li>
