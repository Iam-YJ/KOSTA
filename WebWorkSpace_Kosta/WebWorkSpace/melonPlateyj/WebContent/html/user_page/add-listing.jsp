    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="box_general padding_bottom">
                ...
                <form name="writeForm" method="post" action="${pageContext.request.contextPath}/dispatcher?key=writing&methodName=insertWriting&user_no=1&res_no=2"  onSubmit='return checkValid()'>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>제목</label>
                            <input type="text" class="form-control" name="wri_title" value="">
                        </div>
                    </div>
                    </div>
                <!-- /row-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>내용</label>
                            <textarea style="height:200px;" class="form-control" name="wri_content"></textarea>
                        </div>
                    </div>
                 </div>
                <!-- /row-->
