...
<head>
    ...
    function leaveReview(){
       document.writeForm.user_no.value =sessionStorage.getItem('userNo');
       //alert(sessionStorage.getItem('userNo'));
       //alert(${param.resNo});
...
<body>
   ...
   <!-- /header -->
   <form name="writeForm" method="post" action="${pageContext.request.contextPath}/dispatcher?key=reply&methodName=insertReply" 
         ...
         <div class="row justify-content-center">
            <div class="col-lg-8">
               <div class="box_general write_review">
                  <h1 class="add_bottom_15">Write a review for ${param.resName}</h1>

                  <div class="row">
                     <div class="col-md-3 add_bottom_25">
                        <div class="add_bottom_15">평점 <strong class="food_quality_val"></strong></div>
                            <input type="range" min="0" max="5" step="1" value="0" data-orientation="horizontal" id="food_quality" name="food_quality">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     <label>리뷰</label>
                     <textarea class="form-control" style="height: 180px;" name="review_content" ></textarea>
                  </div>
                  <div class="form-group">
                     <label>사진추가 (옵션)</label>
                     <div class="fileupload"><input type="file" name="fileupload" accept="image/*"></div>
                  </div>
                  <input type=hidden name="res_no" value="${param.resNo}">
                  <input type=hidden name="user_no" value="">
                  <input type="button" class="btn_1" value=작성 onclick="leaveReview();">
               </div>
            </div>
      </div>
      <!-- /row -->
