...
--단어테이블
create table word(
  word_lev varchar2(20) not null,
  word_eng varchar2(100) primary key,
  word_kor varchar2(100) not null,
  word_part varchar2(20)
);

insert into word values('기초','apple','사과',null);
insert into word values('기초','banana','바나나',null);
insert into word values('기초','car','자동차',null);
insert into goods values('중급','ant','개미',null);
insert into goods values('중급','boat','보트',null);
insert into goods values('중급','cat','고양이',null);
insert into goods values('고급','arrow','화살',null);
insert into goods values('고급','borrow','빌리다',null);
insert into goods values('고급','cow','소',null);
