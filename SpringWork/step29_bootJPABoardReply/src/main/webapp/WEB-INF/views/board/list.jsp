...
<table align="center" border="0" cellpadding="5" cellspacing="2"
	...
	<tr>
		...
		<td bgcolor="#00cc00">
			<p align="center">
				<font color="white"><b><span style="font-size: 9pt;">날짜</span></b></font>
			</p>
		</td>
		...
		<c:otherwise>
			<c:forEach items="${requestScope.pageList.content}" var="board">
				<tr onmouseover="this.style.background='#eaeaea'"
					...
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 9pt;"> ${board.writer}</span>
						</p>
					</td>
					...
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 9pt;"> ${board.writeday}</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 9pt;"> ${board.readnum}</span>
						</p>
					</td>
				</tr>
			</c:forEach>
